    ...
    <div className="mt-32 pb-8 flex flex-col items-center relative z-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <div className="flex gap-3 order-2 md:order-none">
          <a href="https://linkedin.com/in/hassan-ezzouhir/" target="_blank" rel="noopener noreferrer"><i className="ri-linkedin-fill ri-2x"></i></a>
          <a href="mailto:hassan.ezz319@gmail.com"><i className="ri-mail-fill ri-2x"></i></a>
        </div>
